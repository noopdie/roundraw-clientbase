function draw(wb, context, x, y) {
    ...
    for (var i = range1; i < range2; i++) {
        ...
        if  (typeof seg[0][seg[0].length-1] == "number" || (seg[0][seg[0].length-1].x + wb[i].z>= 0 && seg[0][seg[0].length-1].y + wb[i].z>= 0)) ctx_.lineTo(seg[0][0] + addx, seg[0][1] + addy);
...
/* 
            ...
            */
            if  (typeof seg[k][seg[k].length-1] == "number" || (seg[k][seg[k].length-1].x + wb[i].z>= 0 && seg[k][seg[k].length-1].y + wb[i].z>= 0))
            ctx_.lineTo(seg[k][0] + addx, seg[k][1] + addy);
            /*
